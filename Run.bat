...
rem "C:/Program Files/QEMU/qemu-system-i386" -L "C:\Program Files\qemu" 
    qemu-system-i386 -cpu pentium3 -serial file:log3.txt -m 32 -rtc base=utc -soundhw pcspk,sb16 -d guest_errors,cpu_reset -monitor stdio -cdrom D:/Users/Alex/Desktop/Banana/Installer/BANANA.ISO -drive file="banana-os/newimage.img",id=abcdefg,if=none -device ich9-ahci,id=ahci -device ide-drive,drive=abcdefg,bus=ahci.0 
