...
rem "C:/Program Files/QEMU/qemu-system-i386" 
    qemu-system-i386 -cpu pentium -serial file:log3.txt -m 32 -rtc base=utc -soundhw pcspk,sb16 -d guest_errors,cpu_reset -monitor stdio -hda banana-os/newimage.img -cdrom D:/Users/Alex/Desktop/Banana/Installer/BANANA.ISO -hdb mikeos.flp
    pause
