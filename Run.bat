...
rem "C:/Program Files/QEMU/qemu-system-i386" -L "C:\Program Files\qemu" 
    qemu-system-i386 -vga std -cpu pentium -serial file:log3.txt -m 4 -fda mikeos.flp -rtc base=utc -soundhw pcspk -d guest_errors,cpu_reset -monitor stdio -hda "banana-os/newimage.img"
