...
rem "C:/Program Files/QEMU/qemu-system-i386" 
    qemu-system-i386 "C:\Program Files\qemu\qemu-system-i386" -L "C:\Program Files\qemu" -cpu 486 -serial file:log3.txt -m 16 -rtc base=utc -soundhw pcspk,sb16 -d guest_errors,cpu_reset -monitor stdio -hda banana-os/newimage.img -cdrom D:/Users/Alex/Desktop/Banana/Installer/BANANA.ISO -hdb mikeos.flp
    pause
