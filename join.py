...
data = open('C:/Users/Alex/Desktop/banana-os/newimage.img', 'rb').read().decode('latin-1')
notboot = data[512:]
...
boot = open('C:/Users/Alex/Desktop/Banana/kernel/STAGE1.BIN', 'rb').read().decode('latin-1') #+=
...
open('C:/Users/Alex/Desktop/banana-os/newimage.img', 'wb').write(data.encode('latin-1'))
